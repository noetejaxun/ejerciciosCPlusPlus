...
namespace Biblioteca {
	...
	public:
		eliminarUsuario(String^ nombre)
		{
			InitializeComponent();
			nameUser = nombre;
			this->grupoUno->Text = "Realmente deseas eliminar a " + nameUser + "?";
			mostrarRegistro();
			//
		...
		void mostrarRegistro(void) {
			...
			MySqlCommand^ cmdDataBase = gcnew MySqlCommand("SELECT id, nombre FROM biblioteca.usuario where nombre = '" + nameUser + "';", conDataBase);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->grupoUno->Size = System::Drawing::Size(670, 222);
			this->grupoUno->TabIndex = 1;
			this->grupoUno->TabStop = false;
			this->grupoUno->Text = L"¿Realmente desea eliminar\?";
			// 
			// visorDatos
			// 
			...
			this->visorDatos->Size = System::Drawing::Size(635, 103);
			...
			this->salir->Location = System::Drawing::Point(354, 163);
			...
			this->salir->Click += gcnew System::EventHandler(this, &eliminarUsuario::salir_Click);
			// 
			// agregarRegistro
			// 
			...
			this->agregarRegistro->Location = System::Drawing::Point(129, 163);
			...
			this->agregarRegistro->Click += gcnew System::EventHandler(this, &eliminarUsuario::agregarRegistro_Click);
			// 
			// eliminarUsuario
			// 
			...
			this->ClientSize = System::Drawing::Size(694, 246);
			this->Controls->Add(this->grupoUno);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::FixedToolWindow;
			this->Name = L"eliminarUsuario";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Eliminar";
			this->Load += gcnew System::EventHandler(this, &eliminarUsuario::eliminarUsuario_Load);
...
#pragma endregion
	private: System::Void eliminarUsuario_Load(System::Object^  sender, System::EventArgs^  e) {

	}
	private: System::Void agregarRegistro_Click(System::Object^  sender, System::EventArgs^  e) {
		String^ constructor = L"datasource=localhost;port=3306;username=root;password=root;";
		MySqlConnection^ conDataBase = gcnew MySqlConnection(constructor);
		MySqlCommand^ cmdDataBase = gcnew MySqlCommand("DELETE FROM biblioteca.usuario WHERE nombre = '" + nameUser + "';", conDataBase);
		...
		try {
			...
			conDataBase->Close();
			MessageBox::Show("Usuario eliminado exitosamente", "Genial", MessageBoxButtons::OK, MessageBoxIcon::Information);
			this->Close();
		}
		catch (Exception^ ex) {
			MessageBox::Show(ex->Message);
