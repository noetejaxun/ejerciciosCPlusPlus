...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->iniciar->Click += gcnew System::EventHandler(this, &Form1::iniciar_Click);
			// 
			// salir
			// 
			...
			this->salir->Click += gcnew System::EventHandler(this, &Form1::salir_Click);
			// 
			// informacion
			// 
			...
			this->informacion->Click += gcnew System::EventHandler(this, &Form1::informacion_Click);
			// 
			// Form1
			// 
