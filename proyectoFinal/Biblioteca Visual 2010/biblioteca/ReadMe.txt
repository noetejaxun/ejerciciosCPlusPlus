========================================================================
   APLICACIÓN: biblioteca Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación biblioteca.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación biblioteca.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado biblioteca.pch y un archivo de tipos 
